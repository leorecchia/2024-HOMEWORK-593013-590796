...
public class LabBuilderTest2 {
	...
	public void testBilocale() {
		Labirinto bilocale = labirintoBuilder.addStanzaIniziale(nomeStanzaIniziale)
				.addStanzaVincente(nomeStanzaVincente).addAdiacenza(nomeStanzaIniziale, nomeStanzaVincente, Direzione.NORD)
...
//	}
	...
	public void testLabirintoConStanzaBloccata_ConPassepartout() {
		this.labirintoBuilder.addStanzaIniziale(nomeStanzaIniziale)
				...
				.addAdiacenza("stanza bloccata", nomeStanzaIniziale, Direzione.SUD).addStanzaVincente(nomeStanzaVincente)
		...
		assertNotEquals(stanzaVincente, labirintoBuilder.getStanze().get("stanza bloccata").getStanzaAdiacente(Direzione.NORD));
	}
	...
	public void testLabirintoConStanzaBloccata_SenzaPassepartout() {
		...
		assertNotEquals(stanzaBloccata, labirintoBuilder.getStanze().get("stanza bloccata").getStanzaAdiacente(Direzione.NORD));
	}
	...
	public void testLabirintoCompletoConTutteLeStanze() {
		...
		Labirinto labirintoCompleto = this.labirintoBuilder.addStanzaIniziale(nomeStanzaIniziale)
				...
				.addAdiacenza("Aula 1", "corridoio bloccato", Direzione.SUD).addAdiacenza("Aula 1", nomeStanzaVincente, Direzione.NORD)
				.addAdiacenza(nomeStanzaVincente, "Aula 1", Direzione.SUD).addAdiacenza("corridoio", "stanza magica", Direzione.EST)
				.addAdiacenza("stanza magica", "corridoio", Direzione.OVEST).addAdiacenza("corridoio", "stanza buia", Direzione.OVEST)
		...
		Collection<Attrezzo> collezioneAttrezzi = corridoio.getAttrezzi().values();
		List<Attrezzo> listaAttrezzi = new LinkedList<Attrezzo>(collezioneAttrezzi);
